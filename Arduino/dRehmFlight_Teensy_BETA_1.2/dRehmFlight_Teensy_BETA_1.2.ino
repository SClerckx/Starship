...
float Ki_roll_angle = 0.4;    //Roll I-gain - angle mode
float Kd_roll_angle = 0.8*0.7;   //Roll D-gain - angle mode (if using controlANGLE2(), set to 0.0)
...
float Kd_pitch_angle = 0.4*0.7;  //Pitch D-gain - angle mode (if using controlANGLE2(), set to 0.0)
